...
public class Film {
	...
	/*
	 * Complete the Film class with attributes that map to the columns of the film
	 * table. Use appropriate datatypes and Java naming conventions. Provide getters
